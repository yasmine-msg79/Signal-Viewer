...
class RealTimeCpuPlot(QMainWindow):
    ...
    def initUI(self):
        ...
        self.ax.set_xlabel('Time (HH:MM:SS)')  # Set the x-axis label
        self.ax.set_ylabel('CPU Usage (%)')  # Set the y-axis label
        self.ax.set_title('Real-Time CPU Usage')  # Set the plot title
    ...
    def update_plot(self):
        ...
        self.ax.plot(times, usages, 'r-', label='CPU Usage')  # Plot the new data
        self.ax.set_xlabel('Time (HH:MM:SS)')  # Set the x-axis label again
        self.ax.set_ylabel('CPU Usage (%)')  # Set the y-axis label again
        self.ax.set_title('Real-Time CPU Usage')  # Set the plot title again
